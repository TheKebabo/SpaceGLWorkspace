...
namespace Engine
{
    ...
    {;
        ...
        else
        {
            ...
            // Cache it anyway (even if -1) to avoid repeated failed lookups
            m_UniformLocationCache[name] = loc;
        }

        // GL_INVALID_INDEX is -1. 
        if (loc == -1) {
    ...
    void ShaderProgram::setBool_w_Name(const std::string &name, bool value)
    {         
    ...
    void ShaderProgram::setInt_w_Name(const std::string &name, int value)
    { 
    ...
    void ShaderProgram::setFloat_w_Name(const std::string &name, float value)
    { 
    ...
    void ShaderProgram::set3Floats_w_Name(const std::string &name, float value0, float value1, float value2)
    {
        glUniform3f(getUniformLocation(name), value0, value1, value2);
    }
    void ShaderProgram::set3Floats_w_Loc(GLint location, float value0, float value1, float value2) const
    {
        glUniform3f(location, value0, value1, value2);
    }
    void ShaderProgram::set4Floats_w_Name(const std::string &name, float value0, float value1, float value2, float value3)
    {
    ...
    void ShaderProgram::setMat4_w_Name(const std::string &name, GLboolean transpose, const GLfloat* value)
    {
